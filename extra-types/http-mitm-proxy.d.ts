...
declare namespace HttpMitmProxy {
  ...
  export interface IProxy extends ICallbacks {
    ...
    onCertificateRequired(
      hostname: string,
      callback: (error: Error | undefined, certDetails: { keyFile: string; certFile: string; hosts: string[] }) => void
    ): void
    onCertificateMissing(
      ...
      callback: (
        ...
        certDetails: { keyFileData: string; certFileData: string; hosts: string[] }
      ) => void
    ): void
